...
export default class EventMap {
  static create() {
    return [
      ...
      new EventHook(Events.CARD_TRAIT_ADDED, 'onTraitAddedToCard'),
      new EventHook(Events.CARD_TRAIT_REMOVED, 'onTraitRemovedFromCard'),
      ...
      new EventHook(Events.ARENA_ENABLED, 'onArenaEnabled'),
    ];
  }
}
